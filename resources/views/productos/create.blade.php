...
@section('subtitle', 'Añadir un artículo al sistema')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="glass-panel rounded-[2.5rem] p-10 relative overflow-hidden">
        ...
        <form action="{{ route('productos.store') }}" method="POST" class="space-y-10 relative z-10">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    <label class="block text-[11px] font-black text-slate-500 uppercase tracking-[0.2em] mb-3 ml-1">Stock Disponible</label>
            ...
            <div class="flex items-center gap-4 p-6 bg-white/5 rounded-3xl border border-white/5">
                <label class="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" name="disponible" value="1" {{ old('disponible', true) ? 'checked' : '' }} class="sr-only peer">
